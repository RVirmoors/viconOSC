...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 375.25, 615.0, 48.0, 22.0 ],
					"style" : "",
					"text" : "writeall"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 810.0, 88.0, 72.0, 22.0 ],
					"style" : "",
					"text" : "loadmess 3"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 630.5, 717.0, 40.0, 22.0 ],
					"style" : "",
					"text" : "r play"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 630.5, 844.0, 63.0, 22.0 ],
					"style" : "",
					"text" : "s Ypredict"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 630.5, 747.0, 20.0, 20.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 630.5, 772.0, 49.0, 22.0 ],
					"style" : "",
					"text" : "play $1"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 630.5, 810.0, 137.0, 22.0 ],
					"style" : "",
					"text" : "mubu.play predict accel"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 592.0, 666.0, 49.0, 22.0 ],
					"style" : "",
					"text" : "clearall"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 86.5, 778.0, 61.0, 22.0 ],
					"style" : "",
					"text" : "record $1",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 86.5, 742.0, 20.0, 20.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 6.5, 847.5, 185.0, 50.0 ],
					"style" : "",
					"text" : "mubu.track predict accel @samplerate 50 @maxsize 10s @predef yes @matrixcols 3"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 46.0, 818.5, 149.0, 22.0 ],
					"style" : "",
					"text" : "mubu.record predict accel"
				}
...
, 			{
				"box" : 				{
					...
					"outputvalues" : 0,
					"patching_rect" : [ 219.0, 654.5, 360.5, 291.5 ],
					"rangeruler_grid" : 0,
					"rangeruler_size" : 30,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 594.0, 496.0, 81.0, 22.0 ],
					"style" : "",
					"text" : "prepend map"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 483.5, 459.0, 39.0, 32.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 614.0, 385.0, 26.0, 22.0 ],
					"style" : "",
					"text" : "r X"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 594.0, 427.0, 39.0, 32.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 483.5, 496.0, 78.0, 22.0 ],
					"style" : "",
					"text" : "prepend add"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 540.5, 543.0, 39.0, 22.0 ],
					"style" : "",
					"text" : "s mlp"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 483.5, 418.0, 29.5, 22.0 ],
					"style" : "",
					"text" : "join"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 483.5, 379.0, 26.0, 22.0 ],
					"style" : "",
					"text" : "r Y"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 531.0, 379.0, 26.0, 22.0 ],
					"style" : "",
					"text" : "r X"
				}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 123.0, 507.0, 306.0, 22.0 ],
													"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 252.0, 159.0, 81.0, 22.0 ],
					"style" : "",
					"text" : "prepend load"
				}
...
,
		"dependency_cache" : [ 			{
				"name" : "nothing.maxpat",
				"bootpath" : "~/Max 7/Packages/CNMAT-Everything-WIN/CNMAT_MMJ-Depot/modules/basic-programming",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
				"name" : "uc_license.maxpat",
				"bootpath" : "~/Max 7/Packages/CNMAT-Everything-WIN/CNMAT_MMJ-Depot/modules/Depot_Support",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
