...
%that was initially created for object interaction also seems to be effective for object finding.
%GRIG: iarasi, fara "seems", fara povesti cu ce am facut. Doar rezultate!
...
We present two applications of our platform: a participative installation, and a performance piece. They are two manifestations of the \textit{SoundThimble} concept and infrastructure, following a sequence of two experiences: (1) the direct interaction with sound in space, and (2) the mediated interaction with sound and space of an audience member. In both cases, the range of sense and perception is extended through new experiences.
