...
- \say{Sound in space} represents another innovative element in this project because introduces the concept of \say{tactile sound}. This means that the sound is an entity, gets a materialization and it becomes switchable. It is not about the \textbf{localization} of sound in space, it is about its \textbf{position}, the coordinates of the sound in space, like an actual \textit{object}. \say{Sound objects} concept represents an innovative tool for multimedia arts such as sketches, imaginary games and realtime interactions.
