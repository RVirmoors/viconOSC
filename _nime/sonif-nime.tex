...
- \say{Sound in space} represents another inovative element in this project because introduces the concept of tactile sound. Is not about the \textbf{localization} of sound in space, is about the \textbf{position}, the coordinates of sound in a real space, like an \textit{object}. Sound objects concept represents an inovative tool for multimedia arts involving sketchs, imaginary games and and realtime interactions.
