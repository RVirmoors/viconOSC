...
- \textit{Sound in space} represents another innovative element in this project because introduces the concept of \textit{tactile sound}.
%GRIG: trebuie o referinta aici. Noi inventam acest concept? Avem nevoie de un concept nou?
This means that the sound is an entity, gets a materialization and it becomes switchable. It is not about the \textbf{localization} of sound in space, it is about its \textbf{position}, the coordinates of the sound in space, like an actual \textit{object}. \textit{Sound objects} concept represents an innovative tool for multimedia arts such as sketches, imaginary games and realtime interactions.
...
Manipulating objects algorithm consists of 3 big steps: object generation, finding the object and releasing the object on the floor. 
