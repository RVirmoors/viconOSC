...
- \say{Sound in space} represents another inovative element in this project because introduces the concept of realtime 3D sound. Is not about the \textbf{localization} of sound in space, is about the \textbf{position}, the coordinates of sound in a real space, like an \textit{object}.
