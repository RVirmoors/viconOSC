...
- performance analysis: Bogdan

\subsection{Dance performance}

- work in progress

- scenario description: semi-improvisation / dance

- music modulation: tempo, filters, ...
...
Future work on SoundThimble could/will include: multiple performers, eye tracking, generative visuals, spatial sound, more powerful synthesis and sound manipulation algorithms, additional mechanics for the auditory game (picking up the object, throwing).
